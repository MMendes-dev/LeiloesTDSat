...
public class vendasVIEW extends javax.swing.JFrame {
    ...
    public vendasVIEW() {
        initComponents();
        // Chama o método para listar os produtos vendidos ao iniciar a tela
    ...
    private void listarProdutosVendidos(){
        try {
            // Certifique-se de que ProdutosDAO está no mesmo pacote ou importado
            ProdutosDAO produtosdao = new ProdutosDAO();
            
            // O nome da sua tabela está correto: tabelaProdutosVendidos
            DefaultTableModel model = (DefaultTableModel) tabelaProdutosVendidos.getModel();
            model.setNumRows(0); // Limpa linhas antigas
            
            // Chama o método do DAO para listar produtos VENDIDOS
            ...
            for(int i = 0; i < listagem.size(); i++){
             ...
             JOptionPane.showMessageDialog(null, "Erro ao carregar lista de vendidos: " + e.getMessage());
